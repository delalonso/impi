...
// Pantalla con boton de reinicio
...
text("En febrero de 2025, Miranda! también colaboró con Lali. El tema combinó la energía y personalidad, manteniendo el estilo llamativo y divertido que caracteriza a la banda. Crearon la cancion: Mejor que vos",posXtexto5,50,240,300);
if(posXtexto5 > 398) {
...
// Funciones propias para estructurar mejor el codigo
// ESTADO 1
void MirandaPortada() {
  if(estado==1) {
 background(#45837B);
...
// Para reiniciar el codigo al tocar el boton
void mousePressed(){
if(estado==7){
